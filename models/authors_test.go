...
var (
	authorDBTypes = map[string]string{`ID`: `int`, `FirstName`: `text`, `LastName`: `text`, `Username`: `varchar`, `Password`: `text`, `Active`: `tinyint`, `Token`: `text`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `DeletedAt`: `timestamp`}
	_             = bytes.MinRead
)
